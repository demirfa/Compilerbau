...
public class SplError extends RuntimeException {
    ...
    public static SplError AssignmentHasDifferentTypes(Position position, Type left, Type right) {
        return new SplError(108, position, "assignment has different types: left = %s, right = %s", left, right);
    }

    public static SplError AssignmentRequiresIntegers(Position position, Type actual) {
        return new SplError(109, position, "assignment requires integer variable: actual = %s", actual);
    }
    ...
    public static SplError OperatorDifferentTypes(Position position, Type left, Type right) {
        return new SplError(118, position, "expression combines different types: left = %s, right = %s", left, right);
    }

    public static SplError ComparisonNonInteger(Position position, Type actual) {
        return new SplError(119, position, "comparison requires integer operands: actual = %s", actual);
    }

    public static SplError ArithmeticOperatorNonInteger(Position position, Type actual) {
        return new SplError(120, position, "arithmetic operation requires integer operands: actual = %s", actual);
    }
