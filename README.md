...
```
cd existing_repo
git remote add origin https://git.thm.de/fndm97/compilerbau-spl-compiler.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.thm.de/fndm97/compilerbau-spl-compiler/-/settings/integrations)
